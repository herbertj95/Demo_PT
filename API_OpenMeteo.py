...
'Functions'
###############################################################################################################################
'Function round_to_next_15_minutes'
"""
...
print(f'Weather forecasts for next {next_hours} hours successfully downloaded in API_Open-Meteo.weather_forecast_15min from Open-Meteo')
